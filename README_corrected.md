...
PyTorch is required **only** for the PINN (`pinn.py`, Figure 3, Tables 5 and 6).
...
| `make_tables.py` | Regenerates ABM validation, the ABM step-size (Table 4), PINN MAE (Table 5, seeds), collocation (Table 6) |
...
| Table 4 (ABM step-size refinement) | `make_tables.py` |
| Table 5 (PINN MAE, mean ± s.d. over seeds) | `make_tables.py --seeds 10` |
